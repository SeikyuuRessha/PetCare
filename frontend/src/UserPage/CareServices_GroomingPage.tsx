...
export default function CareServices_GroomingPage() {
    ...
    return (
      ...
      <section className="flex flex-col md:flex-row items-start px-12 mt-2 mb-8">
        <div className="flex-1 pt-4">
          <h1 className="text-4xl font-bold mb-2">Cắt tỉa lông</h1>
          <p className="mb-4 text-gray-700 text-lg max-w-xl">
            Giúp cho thú cưng của bạn thêm sành điệu, kèm theo kiểu dáng thời thượng cho thú cưng oachxalach.
          </p>
      ...
      <section className="px-12 py-8">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 w-[320px] flex flex-col items-center">
            ...
            <ul className="mb-8 space-y-2 text-base w-full">
              <li className="flex items-center text-[#7bb12b]">
                ...
                <span className="text-black">Tư vấn kiểu lông phù hợp thú cưng.</span>
              </li>
              <li className="flex items-center text-[#7bb12b]">
                <span className="mr-2">✔</span>
                <span className="text-black">Cắt tỉa theo yêu cầu.</span>
              </li>
            </ul>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 w-[320px] flex flex-col items-center">
            ...
            <div className="text-gray-500 mb-2 text-sm">Kèm thêm dịch vụ tắm cho thú cưng.</div>
            ...
            <ul className="mb-8 space-y-2 text-base w-full">
              ...
              <li className="flex items-center text-[#7bb12b]">
                <span className="mr-2">✔</span>
                <span className="text-black">Tắm cho thú cưng của bạn.</span>
              </li>
            </ul>
            <button className="bg-[#1797a6] text-white px-8 py-2 rounded font-semibold text-lg shadow hover:bg-[#127c8a] transition mt-auto">
              Đặt ngay
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 w-[320px] flex flex-col items-center">
            ...
            <div className="text-gray-500 mb-2 text-sm">Dịch vụ Spa mắt xa .</div>
